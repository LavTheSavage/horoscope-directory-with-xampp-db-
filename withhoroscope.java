...
public class withhoroscope {
    public static void main(String[] args) {
        JFrame f1 = new JFrame();
        f1.setSize(370, 330);
        f1.setTitle("Zodiac lel");
        f1.setLayout(null);
        ...
        submitBtn.addActionListener((ActionEvent e) -> {
            try {
                ...
                String horoscope = fetchHoroscope(zodiacSign.toLowerCase());
                ...
                if (horoscope != null) {
                    ...
                    JOptionPane.showMessageDialog(f1, "Your Zodiac Sign is: " + zodiacSign +
                        "\n(Sorry! Couldn't fetch today's horoscope.)");
                }
    ...
    public static String fetchHoroscope(String sign) {
        try {
            URL url = new URL("https://ohmanda.com/api/horoscope/" + sign + "/");
